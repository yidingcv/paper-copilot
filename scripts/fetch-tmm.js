...
const VENUE_NAME = 'tmm';
const DBLP_BASE_URL = 'https://dblp.org/db/journals/tmm/tmm';
...
function generatePaperId(title, authors, year) {
    ...
    return `${lastName}_${cleanTitle}_TMM_${year}_paper`;
}
...
async function startCrawl() {
    console.log(`--- 启动 TMM (Transactions on Multimedia) 抓取 ---`);

    for (const year of YEARS_TO_CRAWL) {
        // 计算卷号: 1999 是 Vol.1
        const volume = year - 1998;
